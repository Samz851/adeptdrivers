...
class RevSliderFront extends RevSliderFunctions {
	...
	public static function add_actions(){
		...
		$add_to		= $output->check_add_to($func->get_val($global, 'includeids', ''));
		...
		wp_enqueue_style('rs-plugin-settings', RS_PLUGIN_URL . 'public/assets/css/settings.css', array(), $rs_ver);
