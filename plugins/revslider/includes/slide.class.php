...
class RevSliderSlide extends RevSliderFunctions {
	...
	public function init_by_post_data($data, RevSliderSlide $template, $slider_id){
		...
		if($this->get_val($this->params, array('seo', 'set')) == true && $this->get_val($this->params, array('seo', 'type')) == 'regular'){
			...
			$matches = array();
			preg_match('/{{meta:\w+}}/', $this->params["link"], $matches);
	...
	private function init_by_facebook($slider_id, $additions){
		...
		if($this->get_val($this->params, array('seo', 'set')) && $this->get_val($this->params, array('seo', 'type')) == 'regular'){
	...
	private function init_by_youtube($slider_id, $additions){
		...
		$bg_type = $this->get_val($this->params, array('bg', 'type'));
		if($bg_type == 'trans' || $bg_type == 'image' || $bg_type == 'streamyoutube' || $bg_type == 'streamyoutubeboth'){ //if image is choosen, use featured image as background
			//facebook check which image size is choosen
