...
class RevSliderSliderExportHtml extends RevSliderSliderExport {
	...
	public function replace_export_html_urls(){
		...
		if($this->export_real){ //only include if real export
			...
			if(!$this->usepcl){
				...
				$this->zip->addFile(RS_PLUGIN_PATH.'/public/assets/css/settings.css', 'css/settings.css');
				...
				$this->pclzip->add(RS_PLUGIN_PATH.'public/assets/css/settings.css', PCLZIP_OPT_REMOVE_PATH, RS_PLUGIN_PATH.'public/assets/css/', PCLZIP_OPT_ADD_PATH, 'css/');
	...
	public function write_header_html(){
		...
		<head>
			...
			<link rel="stylesheet" type="text/css" href="<?php echo $this->path_css; ?>settings.css">
