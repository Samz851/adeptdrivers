...
if ( !function_exists( 'trx_addons_sc_matches' ) ) {
	...
	if (trx_addons_exists_visual_composer()) add_shortcode("trx_sc_matches", "trx_addons_sc_matches");
}
...
if (!function_exists('trx_addons_sc_matches_add_in_vc')) {
	...
	if (trx_addons_exists_visual_composer()) add_action('init', 'trx_addons_sc_matches_add_in_vc', 20);
}
...
if ( !function_exists( 'trx_addons_sc_points' ) ) {
	...
	if (trx_addons_exists_visual_composer()) add_shortcode("trx_sc_points", "trx_addons_sc_points");
}
...
if (!function_exists('trx_addons_sc_points_add_in_vc')) {
	...
	if (trx_addons_exists_visual_composer()) add_action('init', 'trx_addons_sc_points_add_in_vc', 20);
}
?>