...
if ( !function_exists( 'trx_addons_sc_layouts_title' ) ) {
	...
	if (trx_addons_exists_visual_composer()) add_shortcode("trx_sc_layouts_title", "trx_addons_sc_layouts_title");
}
...
if (!function_exists('trx_addons_sc_layouts_title_add_in_vc')) {
	...
	if (trx_addons_exists_visual_composer()) add_action('init', 'trx_addons_sc_layouts_title_add_in_vc', 15);
}
?>