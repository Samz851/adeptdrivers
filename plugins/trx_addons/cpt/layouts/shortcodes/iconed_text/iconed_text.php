...
if ( !function_exists( 'trx_addons_sc_layouts_iconed_text' ) ) {
	...
	if (trx_addons_exists_visual_composer()) add_shortcode("trx_sc_layouts_iconed_text", "trx_addons_sc_layouts_iconed_text");
}
...
if (!function_exists('trx_addons_sc_layouts_iconed_text_add_in_vc')) {
	...
	if (trx_addons_exists_visual_composer()) add_action('init', 'trx_addons_sc_layouts_iconed_text_add_in_vc', 15);
}
?>