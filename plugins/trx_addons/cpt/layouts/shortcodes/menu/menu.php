...
if ( !function_exists( 'trx_addons_sc_layouts_menu' ) ) {
	...
	if (trx_addons_exists_visual_composer()) add_shortcode("trx_sc_layouts_menu", "trx_addons_sc_layouts_menu");
}
...
if (!function_exists('trx_addons_sc_layouts_menu_add_in_vc')) {
				...
				"params" => array_merge(
					array(
						...
						array(
							...
							"description" => wp_kses_data( __("Select menu to insert to the layout. If empty - use menu assigned to the location above", 'trx_addons') ),
							"admin_label" => true,
							"std" => "",
							'dependency' => array(
								'element' => 'location',
						...
						array(
							...
							"group" => esc_html__('Mobile menu', 'trx_addons'),
							"std" => "0",
	...
	if (trx_addons_exists_visual_composer()) add_action('init', 'trx_addons_sc_layouts_menu_add_in_vc', 15);
}
?>