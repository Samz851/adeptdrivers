...
if ( !function_exists( 'trx_addons_sc_dishes' ) ) {
	...
	if (trx_addons_exists_visual_composer()) add_shortcode("trx_sc_dishes", "trx_addons_sc_dishes");
}
...
if (!function_exists('trx_addons_sc_dishes_add_in_vc')) {
	...
	if (trx_addons_exists_visual_composer()) add_action('init', 'trx_addons_sc_dishes_add_in_vc', 20);
}
?>