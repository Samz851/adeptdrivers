...
if ( !function_exists( 'trx_addons_sc_widget_calendar' ) ) {
	...
	if (trx_addons_exists_visual_composer()) add_shortcode("trx_widget_calendar", "trx_addons_sc_widget_calendar");
}
...
if (!function_exists('trx_addons_sc_widget_calendar_add_in_vc')) {
	...
	if (trx_addons_exists_visual_composer()) add_action('init', 'trx_addons_sc_widget_calendar_add_in_vc', 20);
}
?>