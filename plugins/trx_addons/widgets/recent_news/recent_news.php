...
if ( !function_exists( 'trx_addons_sc_recent_news' ) ) {
	...
	if (trx_addons_exists_visual_composer()) add_shortcode("trx_widget_recent_news", "trx_addons_sc_recent_news");
}
...
if (!function_exists('trx_addons_sc_recent_news_add_in_vc')) {
	...
	if (trx_addons_exists_visual_composer()) add_action('init', 'trx_addons_sc_recent_news_add_in_vc', 20);
}
?>